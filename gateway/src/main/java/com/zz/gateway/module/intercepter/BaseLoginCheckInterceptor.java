package com.zz.gateway.module.intercepter;
...
//import com.zz.common.common.interceptor.CustomerLoginCheckInterceptor;
...
import com.zz.gateway.module.system.login.LoginServer;
...
//        //放行的Uri前缀
        ...
        try {
//            userInfo =JSONObject.parseObject( testService.get(),UserInfoEntity.class);
        } catch (Exception e) {
